...
SHA="1c68274911650074a000b51f14d62597c24e0ad1e306d69c0c3d109e3b424ef4"
...
if [[ -e /usr/bin/bspatch ]]; then
	...
	do
		...
		echo
		echo "本补丁仅适用于 Navicat Premium 12.0.28 简体中文版, 请确认您已将程序安装至应用程序目录?"
		echo "  1) 已经安装原版"
		echo "  2) 退出补丁"
		...
		case $option in
			...
			if [[ "$FILESHA" == "$SHA" ]]; then
				...
				echo "您的文件版本不正确, 或已被修改, 请通过官方网站下载 Navicat Premium 12.0.28 简体中文版."
				exit 3
			fi
			exit
			;;
